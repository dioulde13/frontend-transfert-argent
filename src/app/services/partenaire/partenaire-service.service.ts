...
export class PartenaireServiceService {
  ...
  getAllPartenaireCreancier(): Observable<any> {
    return this.http.get(`${this.apiUrl}/api/creancierPartenaire/liste`);
  }
  ...
  ajouterPartenaireCreancier(partenaireDataCreancier: any): Observable<any> {
    return this.http.post(`${this.apiUrl}/api/creancierPartenaire/create`, partenaireDataCreancier);
  }
